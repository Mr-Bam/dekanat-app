...
@section('content')
    ...
    <form action="/admin/students" method="POST">
        ...
        <input id="first_name" class="form-control mb-3" type="text" name="first_name">

        <label for="last_name">Last Name</label>
        <input id="last_name" class="form-control mb-3" type="text" name="last_name">

        <label for="course">Course</label>
        <input id="course" class="form-control mb-3" type="number" min="1" name="course">

        <label for="rating">Rating</label>
        <input id="rating" class="form-control mb-3" type="number" min="0" name="rating">
